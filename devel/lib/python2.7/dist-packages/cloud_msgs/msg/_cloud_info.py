...
class cloud_info(genpy.Message):
  _md5sum = "6297cb853029467c5461fd34cbd847b1"
...
string frame_id
"""
  __slots__ = ['header','startRingIndex','endRingIndex','startOrientation','endOrientation','orientationDiff','segmentedCloudGroundFlag','segmentedCloudColInd','segmentedCloudRange','XM','Xm','YM','Ym','ZM','Zm']
  _slot_types = ['std_msgs/Header','int32[]','int32[]','float32','float32','float32','bool[]','uint32[]','float32[]','float32','float32','float32','float32','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,startRingIndex,endRingIndex,startOrientation,endOrientation,orientationDiff,segmentedCloudGroundFlag,segmentedCloudColInd,segmentedCloudRange,XM,Xm,YM,Ym,ZM,Zm
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6f().pack(_x.XM, _x.Xm, _x.YM, _x.Ym, _x.ZM, _x.Zm))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.XM, _x.Xm, _x.YM, _x.Ym, _x.ZM, _x.Zm,) = _get_struct_6f().unpack(str[start:end])
      return self
