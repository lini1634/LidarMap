...
(cl:defmethod XM-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cloud_msgs-msg:XM-val is deprecated.  Use cloud_msgs-msg:XM instead.")
  (XM m))
...
(cl:defmethod YM-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cloud_msgs-msg:YM-val is deprecated.  Use cloud_msgs-msg:YM instead.")
  (YM m))
...
(cl:ensure-generic-function 'ZM-val :lambda-list '(m))
(cl:defmethod ZM-val ((m <cloud_info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cloud_msgs-msg:ZM-val is deprecated.  Use cloud_msgs-msg:ZM instead.")
  (ZM m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <cloud_info>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'Ym))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'ZM))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <cloud_info>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'segmentedCloudRange)))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'ZM) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<cloud_info>)))
  ...
  "6297cb853029467c5461fd34cbd847b1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'cloud_info)))
  "Returns md5sum for a message object of type 'cloud_info"
  "6297cb853029467c5461fd34cbd847b1")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<cloud_info>)))
  ...
  (cl:format cl:nil "Header header ~%~%int32[] startRingIndex~%int32[] endRingIndex~%~%float32 startOrientation~%float32 endOrientation~%float32 orientationDiff~%~%bool[]    segmentedCloudGroundFlag # true - ground point, false - other points~%uint32[]  segmentedCloudColInd # point column index in range image~%float32[] segmentedCloudRange # point range ~%~%float32 XM~%float32 Xm~%float32 YM~%float32 Ym~%float32 ZM~%float32 Zm~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'cloud_info)))
  "Returns full string definition for message of type 'cloud_info"
  (cl:format cl:nil "Header header ~%~%int32[] startRingIndex~%int32[] endRingIndex~%~%float32 startOrientation~%float32 endOrientation~%float32 orientationDiff~%~%bool[]    segmentedCloudGroundFlag # true - ground point, false - other points~%uint32[]  segmentedCloudColInd # point column index in range image~%float32[] segmentedCloudRange # point range ~%~%float32 XM~%float32 Xm~%float32 YM~%float32 Ym~%float32 ZM~%float32 Zm~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
